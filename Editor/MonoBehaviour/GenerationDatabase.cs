namespace GenericUnityObjects.Editor.MonoBehaviour
{
    ...
    internal abstract class GenerationDatabase<TDatabase> :
        ...
        where TDatabase : GenerationDatabase<TDatabase>
    {
        ...
        /// <summary>
        /// Must NEVER be used on open generic type (GenerationDatabase&lt;Database, GenericTypeInfo>).
        /// Call it only on a concrete type (BehavioursGenerationDatabase).
        /// </summary>
