namespace GenericUnityObjects.EditorTests
{
    ...
    internal partial class GenericBehavioursDatabaseTests
    {
        public class AddConcreteClass : GenericBehavioursDatabaseTests
        {
            ...
            {
                _database.InstanceAddConcreteClass(_behaviour, _firstSecondArgs, AssemblyGUID);
                bool success = _database.InstanceTryGetReferencedBehaviours(_firstArg, out TypeInfo[] firstBehaviours);
                Assert.IsTrue(success);
            ...
            {
                var secondBehaviour = new TypeInfo("secondBehaviourName", "secondBehaviourGUID");
                ...
                bool success = _database.InstanceTryGetReferencedBehaviours(_firstArg, out TypeInfo[] actualBehaviours);
                Assert.IsTrue(success);
